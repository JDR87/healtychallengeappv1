...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _initChannel() async {
    Channel channel = await APIService.instance
        .fetchChannel(channelId: 'UCrRbXRi8432u_irHjKPlHrQ'
        //'UCrRbXRi8432u_irHjKPlHrQ' deporte

      //UCP3EX5VKeaG4Oa2qTKPuEFA offspring
    );
    setState(() {
      _channel = channel;
    });
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: Colors.black,gradient: LinearGradient(
          begin: Alignment.topCenter,
          end: Alignment.bottomCenter,
          stops: [
            0.1,
